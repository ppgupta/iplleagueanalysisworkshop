...
public class IPLAnalysisTest {
	...
	@Test
	public void givenMostRunCsvFileWhenSortedByBounndariesShouldReturnPlayerWithHighestBoundaries() throws IplAnalyserException {
	...
	@Test
	public void givenMostRunCsvFileWhenSortedBySRAndBoundariesShouldReturnHighestSRFirst() throws IplAnalyserException {
		String sortedData = iplAnalyser.sortRunData(MOSTRUNS_FILE_PATH, MostRunSortType.SR);
		MostRun[] highestAvgData = new Gson().fromJson(sortedData, MostRun[].class);
		Assert.assertEquals(333.33, highestAvgData[0].getStrikeRate(), 0.0);
		Assert.assertEquals("Ishant Sharma", highestAvgData[0].getPlayer());
	...
	@Test
	public void givenMostRunCsvFileWhenSortedShouldReturnHighestAverageWithBestSR() throws IplAnalyserException {
